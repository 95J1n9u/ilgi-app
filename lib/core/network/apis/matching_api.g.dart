...
class _MatchingApi implements MatchingApi {
  _MatchingApi(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<MatchingCandidatesResponse> getMatchingCandidates(
    String token,
    MatchingCandidatesRequest request,
  ) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MatchingCandidatesResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = MatchingCandidatesResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<CompatibilityResponse> calculateCompatibility(
    ...
    _data.addAll(request.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CompatibilityResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<MatchingUserProfile> getMatchingProfile(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MatchingUserProfile>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/api/v1/matching/profile/${userId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = MatchingUserProfile.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<Map<String, dynamic>> getMatchingPreferences(String token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<BaseResponse> submitMatchingFeedback(
    String token,
    MatchingFeedbackRequest request,
  ) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
  ...
  Future<Map<String, dynamic>> getMatchingAnalytics(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/api/v1/matching/analytics/${userId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
